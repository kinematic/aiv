...
use app\models\sites\Relations;

/**
 * RelationsSearch represents the model behind the search form about `app\models\Relations`.
 */
class RelationsSearch extends Relations
{
    ...
    public function rules()
    {
        return [
            ...
            [['nr', 'description', 'opendate', 'closedate', 'inventdate'], 'safe'],
        ];
    }
